 ...
 *
 */
 class GeoCLEF_EN_2008_094_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2008_094_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:094 Demonstrations in German cities"
/*
...
*/
		...
		assert question.sentence*.text == ['Demonstrations','in','German','cities']
		assert question.questionType == QuestionType.None
		assert question.questionTypeTerms.size() == 0

	// check detected NEs 
		assert question.nes.size() == 0
//		assert question.nes[0].terms*.text == ['German']
...
/*		assert question.conditions[0].object instanceof QueryGeoscope
		assert question.conditions[0].operator.op == Operator.Locator.In
		assert question.conditions[0].object.ne.terms*.text ==  ['German']
*/			
