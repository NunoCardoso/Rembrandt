 ...
 *
 */
 class GeoCLEF_PT_2006_045_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2006_045_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:045 turismo no nordeste do Brasil"
...
*/
		...
		assert question.sentence*.text == ['turismo','no','nordeste','do','Brasil']
	...
	// check detected NEs 
		...
		assert question.nes[0].terms*.text == ['Brasil']
	...
	// check conditions 
		...
		assert question.conditions[0].operator.op == Operator.Locator.Northeast
		assert question.conditions[0].object.ne.terms*.text == ['Brasil']	
...
label:045 contents:turismo contents:nordeste contents:"Brasil" woeid-index:23424768
"""
