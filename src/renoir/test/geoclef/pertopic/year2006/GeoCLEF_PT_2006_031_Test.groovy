 ...
 *
 */
 class GeoCLEF_PT_2006_031_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2006_031_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:031 Combates e embargo no norte do Iraque"
/*
...
*/
		...
		assert question.sentence*.text == ['Combates','e','embargo','no','norte','do','Iraque']
	...
	// check detected NEs 
		...
		assert question.nes[0].terms*.text == ['Iraque']
	...
	// check conditions 
		...
		assert question.conditions[0].object.ne.terms*.text == ['Iraque']
