 ...
 *
 */
class HTMLReaderTest extends ReaderTest {

	public HTMLReaderTest() {
		super()
		this.reader_generated = new HTMLReader(new HTMLStyleTag("pt"))
		this.reader_expected = new RembrandtReader(new RembrandtStyleTag("pt"))
	}

	void testReaderPlainHTML() {
		this.file_input = conf.get("rembrandt.home.dir") + fileseparator + "resources" +
				fileseparator + "test" + fileseparator + "io" + fileseparator + "Rembrandt1File_htmlformat_plain.txt"
