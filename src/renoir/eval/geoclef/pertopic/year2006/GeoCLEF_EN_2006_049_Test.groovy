 ...
 *
 */
 class GeoCLEF_EN_2006_049_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2006_049_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:049 ETA activity in France"
/*		
...
*/
		...
		assert question.sentence*.text == ['ETA','activity','in','France']
