 ...
 *
 */
 class GeoCLEF_PT_2007_054_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2007_054_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:054 Prejuízos causados por chuvas ácidas no norte da Europa"
/*
...
*/
		...
		assert question.sentence*.text == ['Prejuízos','causados','por','chuvas','ácidas','no','Norte','da','Europa']
