 ...
 *
 */
 class GeoCLEF_PT_2007_064_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2007_064_Test() {
    ...
    void testTopic() {
		String lang = "pt"
//		String topic = "label:064 Acontecimentos desportivos na Suíça francesa"
		String topic = "label:064 acontecimentos desportivos na Suíça"
/*
...
*/
		...
		assert question.sentence*.text == ['acontecimentos','desportivos','na','Suíça']
...
//		assert question.nes[0].classification.find{it == SC.organization}
		assert question.nes[0].terms*.text == ['Suíça']
...
//		assert question.conditions[0].object.geoscopeTerms*.text == ['Rússia']
		...
		assert question.conditions[0].object.ne.terms*.text ==  ['Suíça']
...
label:064 contents:acontecimentos contents:desportivos contents:"Suíça" woeid-index:23424957
"""
