 ...
 *
 */
 class GeoCLEF_EN_2007_056_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2007_056_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:056 Lakes with monsters"
/*
...
*/
		...
		assert question.sentence*.text == ['Lakes','with','monsters']
	...
	// check detected NEs 
		...
		assert question.nes[0].terms*.text == ['Lakes']
