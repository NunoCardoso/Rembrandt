 ...
 *
 */
 class GeoCLEF_PT_2007_067_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2007_067_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:067 Pistas em que Ayrton Senna correu em 1994"
/*
...
*/
		...
		assert question.sentence*.text == ['Pistas','em','que','Ayrton','Senna','correu','em','1994']
		assert question.questionType == QuestionType.None
		assert question.questionTypeTerms.size() == 0

	// check detected NEs 
		assert question.nes.size() == 2
		assert question.nes[0].terms*.text == ['Ayrton','Senna']
		assert question.nes[0].classification.find{it == SC.person_individual}
		assert question.nes[1].terms*.text == ['em','1994']
