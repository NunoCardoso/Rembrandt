...
/**
 * @author Nuno Cardoso
 * Indexes the Wikipedia preprocessed XML into Lucene indexes.
 * Usage: IndexWikipedia [conf] (processHash:[0.1]) (rebuildInlinkTable[0.1]) (indexFullText[0.1])"
...
class IndexWikipedia { 
	...
	static void main(args) {
	    ...
	    def handler = new WikipediaHandler(conf)
