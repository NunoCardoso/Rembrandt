...
class SubjectAndPlaceDetector extends Detector {
	...
	rules_pt = [
	   new Rule(id:'Sbj_AdjPlc', description:'músicos portugueses', 
	      ...
	      clauses:[CC.beginSentence1, subject1pt, placeAdjective1pt], 
	   ...
	   new Rule(id:'Sbj_de_PlcNam', description:'Músicos de Portugal',
	      clauses:[CC.beginSentence1, subject1pt, ClausesPT.dnaeosem1c, placeName1pt], 
		action:[{Expando q, MatcherObject o -> 
	   ...
	   new Rule(id:'Sbj', description:'Músicos',
		clauses:[CC.beginSentence1, subject1pt, CC.endSentence1], 
		action:[{Expando q, MatcherObject o -> 
		q.subjectMatch = o.getMatchByClause(subject1pt)
		q.subjectTerms = q.subjectMatch.terms			
		q.matchedRuleID = 'Sbj'
	...
	rules_en = [
		 ...
		 clauses:[CC.beginSentence1, placeAdjective1en, subject1en], 
	 	 action:[{Expando q, MatcherObject o -> 	 	     
 	   ...
 	   new Rule(id:'Sbj_of_Adj', description:'Musicians of Portugal', 
 	      clauses:[CC.beginSentence1, subject1en, ClausesEN.of1c, ClausesEN.the01c, placeName1en], 
 		action:[{Expando q, MatcherObject o ->      
 	   ...
 	   new Rule(id:'Sbj', description:'Musicians',
 		clauses:[CC.beginSentence1, subject1en, CC.endSentence1], 
 		action:[{Expando q, MatcherObject o -> 
 		q.subjectMatch = o.getMatchByClause(subject1en)
		q.subjectTerms = q.subjectMatch.terms		
 		q.matchedRuleID = 'Sbj'
