 ...
 * @author Nuno Cardoso
 */
class GeoCLEF_2006_PT_OptimizedBM25_noQE_Test extends GeoCLEF_Baseline_NoQE_RunGeneration_Test {
    ...
    public GeoCLEF_2006_PT_OptimizedBM25_noQE_Test() {
	...
	super.queries.each{q -> 
            ...
            query.paramsForQueryConfiguration["bm25.k1"] = "0.4d"
            query.paramsForQueryConfiguration["bm25.b"] = "0.4d"
