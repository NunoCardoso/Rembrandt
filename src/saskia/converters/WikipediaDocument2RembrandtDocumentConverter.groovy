...
class WikipediaDocument2RembrandtDocumentConverter {
	...
	public WikipediaDocument2RembrandtDocumentConverter(String lang) {
		this.lang=lang
	...
	*/
	...
	static main(args) {
		...
		WikipediaDocument2RembrandtDocumentConverter w2h = \
		    new WikipediaDocument2RembrandtDocumentConverter(lang)
