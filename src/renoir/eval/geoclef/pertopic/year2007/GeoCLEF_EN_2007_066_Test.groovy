 ...
 *
 */
 class GeoCLEF_EN_2007_066_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2007_066_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:066 Economy in the Bosphorus"
/*
...
*/
		...
		assert question.sentence*.text == ['Economy','in','the','Bosphorus']
...
// http://dbpedia.org/page/Bosphorus não tem classe, e QWikipédia não ajuda
	...
	// check detected NEs 
		...
		assert question.nes[0].terms*.text == ['Economy']
		assert question.nes[0].classification.find{it == SC.abstraction_discipline}
//		assert question.nes[1].terms*.text == ['Bosphorus']
...
label:066 contents:"Economy" contents:Bosphorus entity:Economy
