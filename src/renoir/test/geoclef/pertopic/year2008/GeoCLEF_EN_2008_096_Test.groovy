 ...
 *
 */
 class GeoCLEF_EN_2008_096_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2008_096_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:096 economic boom in Southeast Asia"
/*
...
*/
		...
		assert question.sentence*.text == ['economic','boom','in','Southeast','Asia']
		assert question.questionType == QuestionType.None
		assert question.questionTypeTerms.size() == 0

	// check detected NEs 
		assert question.nes.size() == 1
		assert question.nes[0].terms*.text == ['Southeast','Asia']
...
*/	
		...
		assert question.conditions[0].operator.op == Operator.Locator.In
		assert question.conditions[0].object.ne.terms*.text ==  ['Southeast','Asia']
