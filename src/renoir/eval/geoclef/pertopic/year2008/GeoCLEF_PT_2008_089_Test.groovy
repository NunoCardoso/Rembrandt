 ...
 *
 */
 class GeoCLEF_PT_2008_089_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2008_089_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:089 feiras na Baixa Saxônia"
/*
...
*/
		...
		assert question.sentence*.text == ['feiras','na','Baixa','Saxônia']
