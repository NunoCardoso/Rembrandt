...
class InputDirectoryValidator extends Validator {
	...
	public File validate(String given_directory, 
		...
		String directory
		if (!given_directory) {
			println "Which output directory for import files? (Default: ${DEFAULT_DIRECTORY}) "
			print "> "
		...
		if (file.exists()) {
			...
			log.fatal "Directory of input files $directory does not exist."
			System.exit(0)
		}
