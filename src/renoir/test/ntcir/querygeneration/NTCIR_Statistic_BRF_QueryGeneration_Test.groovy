 ...
 */
class NTCIR_Statistic_BRF_QueryGeneration_Test extends NTCIR_QueryGeneration_Test {
    ...
    public NTCIR_Statistic_BRF_QueryGeneration_Test(topic_file, query_file, collection, lang, Boolean stem) {
	super(topic_file, query_file, lang)
	renoir = new Renoir(Configuration.newInstance(), collection, lang, stem)
	
    }
      
    void generate(bm25_k1 = 2.0d, bm25_b = 0.75d, topkterm = 16, topkdoc = 10) {
