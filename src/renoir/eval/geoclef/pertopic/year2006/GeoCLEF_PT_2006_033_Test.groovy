 ...
 *
 */
 class GeoCLEF_PT_2006_033_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2006_033_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:033 Competições desportivas internacionais no Ruhr"
		...
		assert question.sentence*.text == ['Competições','desportivas','internacionais','no','Ruhr']
	...
	// Ruhr existe na DBpedia, mas sem classe. Ruhn não é apanhado pela Wikipédia, retorna EM 
...
label:033 contents:Competições contents:desportivas contents:internacionais contents:Ruhr
"""
