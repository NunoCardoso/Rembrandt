 ...
 *
 */
 class GeoCLEF_EN_2008_084_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2008_084_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:084 Bombings in Northern Ireland"
...
*/
		...
		assert question.sentence*.text == ['Bombings','in','Northern','Ireland']
...
//		assert question.nes[0].classification.find{it == SC.organization}
		assert question.nes[0].terms*.text == ['Northern','Ireland']
...
*/		assert question.conditions[0].object instanceof QueryGeoscope
		assert question.conditions[0].operator.op == Operator.Locator.In
		assert question.conditions[0].object.ne.terms*.text ==  ['Northern','Ireland']
