 ...
 *
 */
class GeoCLEF_QueryGeneration_Test extends GroovyTestCase {
    ...
    public GeoCLEF_QueryGeneration_Test(topic_file, query_file, lang) {
 ...
 // initialize by reading the topics and qrels
	...
	fileseparator+"geoclef"+fileseparator+"logs"+fileseparator+query_file+".querygenerationlog"
	logf = new File(logfile)

	topicfile = homedir+fileseparator+"resources"+fileseparator+"eval"+
            fileseparator+"geoclef"+fileseparator+"topics"+fileseparator+topic_file
