 ...
 *
 */
 class GeoCLEF_PT_2006_041_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2006_041_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:041 Naufrágios no Oceano Atlântico"
...
*/
		...
		assert question.sentence*.text == ['Naufrágios','no','Oceano','Atlântico']
	...
	// check detected NEs 
		...
		assert question.nes[0].terms*.text == ['Oceano','Atlântico']
	...
	// check conditions 
		...
		assert question.conditions[0].object.ne.terms*.text == ['Oceano','Atlântico']
