 ...
 */
public class TimeRulesPTTest extends RulesTest {
    
    static String path = Configuration.newInstance().get("rembrandt.home.dir",".")
    
    public TimeRulesPTTest() {	  
        super("pt","harem", path+"/resources/test/ExternalEvidencePT_Time.txt",
        path+"/resources/test/ExternalEvidencePT_Time_output.txt"
