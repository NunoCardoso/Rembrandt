 ...
 *
 */
 class GeoCLEF_EN_2008_080_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2008_080_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:080 politicians in exile in Germany"
...
*/
		...
		assert question.sentence*.text == ['politicians','in','exile','in','Germany']
