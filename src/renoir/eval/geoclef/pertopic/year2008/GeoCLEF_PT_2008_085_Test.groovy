 ...
 *
 */
 class GeoCLEF_PT_2008_085_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2008_085_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:085 Realização de testes nucleares no Oceano Pacífico"// Sul" 
/*
...
*/
		...
		assert question.sentence*.text == ['Realização','de','testes','nucleares','no','Oceano','Pacífico']
...
// Sahara is grounded to Deserto do Saara, but can't make a NE out of it.
	...
	// check detected NEs 
		...
		assert question.nes[0].terms*.text == ['Oceano','Pacífico']
