 ...
 * Tester for Sentence.
 */
class TestSentence extends GroovyTestCase {
   ...
   void testNewSentence() {	
      ...
      List<Term> terms = [new Term("A",0),new Term("B",1)]
   ...
   void testVisibleTerms() {
      ...
      // 6 visible terms, 10 terms total. 
       List<Term> mixedterms = [new Term("O",0,false),new Term("<B>",-1, true),
                  new Term("REMBRANDT",1,false), new Term("</B>",-1,true),
                  new Term("é",2,false), new Term("um",3, false),
                  new Term("<I>",-1,true),new Term("pintor",4,false),
                  new Term("</I>",-1,true), new Term(".",5,false)]
      List<Term> visterms = [new Term("O",0,false),  new Term("REMBRANDT",1,false), 
                 new Term("é",2,false), new Term("um",3, false),
                 new Term("pintor",4,false), new Term(".",5,false)]
