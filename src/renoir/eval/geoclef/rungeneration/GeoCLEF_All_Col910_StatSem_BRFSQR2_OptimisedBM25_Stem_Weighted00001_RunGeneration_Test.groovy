 ...
 *
 */
class GeoCLEF_All_Col910_StatSem_BRFSQR2_OptimisedBM25_Stem_Weighted00001_RunGeneration_Test extends GroovyTestCase {
    ...
    static Logger log = Logger.getLogger("RenoirTest")
	 ...
	 static String weight="00001"	
    static boolean dostem = true
	 
    public GeoCLEF_All_Col910_StatSem_BRFSQR2_OptimisedBM25_Stem_Weighted00001_RunGeneration_Test() {}
