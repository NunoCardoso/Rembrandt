 ...
 *
 */
class GeoCLEF_All_Col910_StatSem_BRFSQR2_OptimisedBM25_Stem_Weighted01_RunGeneration_Test extends GroovyTestCase {
    ...
    static Logger log = Logger.getLogger("RenoirTest")
	 ...
	 static String weight="01"	
    static boolean dostem = true
	 
    public GeoCLEF_All_Col910_StatSem_BRFSQR2_OptimisedBM25_Stem_Weighted01_RunGeneration_Test() {}
