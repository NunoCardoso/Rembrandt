 ...
 */
class GeoCLEF_Semantic_SQR2_QueryGeneration_Test extends GeoCLEF_QueryGeneration_Test {
    ...
    public GeoCLEF_Semantic_SQR2_QueryGeneration_Test(topic_file, query_file, collection, lang) {
	super(topic_file, query_file, lang)
	renoir = new Renoir(Configuration.newInstance(), collection, lang)
	...
	topics.each{topicline -> 
	   ...
	   RenoirQuery query = RenoirQueryParser.parse(topicline)
	    ...
	    // let's tell it to do SQR QE
	   query.paramsForRenoir['qe']="sqr"
