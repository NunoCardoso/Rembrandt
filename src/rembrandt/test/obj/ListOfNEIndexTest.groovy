...
class TestListOfNEIndex extends GroovyTestCase {
	...
	classification:[new SemanticClassification('ORGANIZACAO','INSTITUICAO') ] )
	...
	classification:[new SemanticClassification('LOCAL','ADMINISTRATIVO') ] )   
	
	ne4 = new NamedEntity(sentenceIndex:0, termIndex:4,	
	terms:Sentence.simpleTokenize('Recreativa',0,4), 
	classification:[new SemanticClassification('ABSTRACCAO','DISCIPLINA') ] )
	
	ne5 = new NamedEntity(sentenceIndex:0, termIndex:0,	
	terms:Sentence.simpleTokenize('A Associação',0,0), 
	classification:[new SemanticClassification('ORGANIZACAO','ADMINISTRACAO') ] )
