...
q.answer << dbpedia.getDBpediaResourceFromWikipediaPageTitle("AndrŽ Rieu","pt")
...
q.answer << dbpedia.getDBpediaResourceFromWikipediaPageTitle("ArmŽnia","pt")
q.answer << dbpedia.getDBpediaResourceFromWikipediaPageTitle("çustria","pt")
q.answer << dbpedia.getDBpediaResourceFromWikipediaPageTitle("Azerbaij‹o","pt")
q.answer << dbpedia.getDBpediaResourceFromWikipediaPageTitle("Bielorrœssia","pt")
q.answer << dbpedia.getDBpediaResourceFromWikipediaPageTitle("Bulg‡ria","pt")
q.answer << dbpedia.getDBpediaResourceFromWikipediaPageTitle("BŽlgica","pt")
...
q.answer << dbpedia.getDBpediaResourceFromWikipediaPageTitle("EslovŽnia","pt")
...
q.answer << dbpedia.getDBpediaResourceFromWikipediaPageTitle("Ligœria","pt")
...
/*
q.id="GC-2009-25"
q.answer << dbpedia.getDBpediaResourceFromWikipediaPageTitle("Marc GenŽ","pt")
...
q.answer << dbpedia.getDBpediaResourceFromWikipediaPageTitle("çustria","pt")
q.answer << dbpedia.getDBpediaResourceFromWikipediaPageTitle("It‡lia","pt")
q.answer << dbpedia.getDBpediaResourceFromWikipediaPageTitle("Repœblica Dominicanas","pt")
...
q.answer << dbpedia.getDBpediaResourceFromWikipediaPageTitle("Karoline KrŸger","pt")
...
q.answer << dbpedia.getDBpediaResourceFromWikipediaPageTitle("Cyrus (mœsico)","pt")
...
q.answer << dbpedia.getDBpediaResourceFromWikipediaPageTitle("LŒtefossen","en")
...
q.answer << dbpedia.getDBpediaResourceFromWikipediaPageTitle("MŒnafossen","en")
...
q.answer << dbpedia.getDBpediaResourceFromWikipediaPageTitle("GaltŸr","en")
...
q.answer << dbpedia.getDBpediaResourceFromWikipediaPageTitle("KitzbŸhel","en")
...
q.answer << dbpedia.getDBpediaResourceFromWikipediaPageTitle("Ski AmadŽ","en")
q.answer << dbpedia.getDBpediaResourceFromWikipediaPageTitle("Sšlden","en")
q.answer << dbpedia.getDBpediaResourceFromWikipediaPageTitle("Vandans","en")
q.answer << dbpedia.getDBpediaResourceFromWikipediaPageTitle("ZŸrs","en")
