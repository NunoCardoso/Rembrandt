...
package renoir.eval.geoclef.rungeneration
 ...
 *
 */
class GeoCLEF_All_Col910_StatSem_BRFSQR2_OptimisedBM25_Stem_filterWOEID_RunGeneration_Test extends GroovyTestCase {
    ...
    static Logger log = Logger.getLogger("RenoirTest")
	 ...
	 static String stem ="Stem"
	 static String weight="filterWOEID"	
    static boolean dostem = true
	 
    public GeoCLEF_All_Col910_StatSem_BRFSQR2_OptimisedBM25_Stem_filterWOEID_RunGeneration_Test() {}
    ...
    public GeoCLEF_Baseline_NoQE_RunGeneration_Test create(year, collection_id, lang) {
		...
		"GeoCLEF_${lang.toUpperCase()}_${year}_${col}_${type}_${model}_${stem}_${weight}.query", 
		"qrelsGeoCLEF${lang.toUpperCase()}${year}.txt", 
		"GeoCLEF_${lang.toUpperCase()}_${year}_${col}_${type}_${model}_${stem}_${weight}.run", 
