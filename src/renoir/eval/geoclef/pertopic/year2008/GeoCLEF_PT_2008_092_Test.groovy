 ...
 *
 */
 class GeoCLEF_PT_2008_092_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2008_092_Test() {
...
//		assert question.nes[1].terms*.text == ['Europa','Ocidental']
...
label:092 contents:Fundamentalistas contents:islâmicos contents:Europa contents:Ocidental
