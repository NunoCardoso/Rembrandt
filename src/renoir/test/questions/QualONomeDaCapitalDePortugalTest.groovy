 ...
 * @author Nuno Cardoso
 */
class TestQualONomeDaCapitalDePortugal extends GroovyTestCase {
	...
	public TestQualONomeDaCapitalDePortugal() {
		// initialize
  ...
  void testQualONomeDaCapitalDePortugal() {
  
	 // **** 8. Qual o nome da capital de Portugal? ***
	 String line = """
