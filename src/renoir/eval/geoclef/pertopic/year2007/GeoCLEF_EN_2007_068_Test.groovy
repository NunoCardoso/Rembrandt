 ...
 *
 */
 class GeoCLEF_EN_2007_068_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2007_068_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:068 Rivers with floods"
/*
...
*/
		...
		assert question.sentence*.text == ['Rivers','with','floods']
...
// F1 returns EM only, but it is grounded:  title=Formula One.
	...
	//	assert question.nes[0].classification.find{it == SC.abstraction_discipline}
		assert question.nes[0].terms*.text == ['Rivers']
...
label:068 contents:"Rivers" contents:floods entity:Rivers
"""
