 ...
 *
 */
 class GeoCLEF_PT_2008_080_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2008_080_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:080 políticos exilados na Alemanha" 
/*
...
*/
		...
		assert question.sentence*.text == ['políticos','exilados','na','Alemanha']
