 ...
 *
 */
 class GeoCLEF_EN_2007_064_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2007_064_Test() {
    ...
    void testTopic() {
		String lang = "en"
//		String topic = "label:064 sport events in the french speaking part of Switzerland"
		String topic = "label:064 sport events in Switzerland"
/*
...
*/
		...
		assert question.sentence*.text == ['sport','events','in','Switzerland']
...
//		assert question.nes[0].classification.find{it == SC.organization}
		assert question.nes[0].terms*.text == ['Switzerland']
...
*/		
		...
		assert question.conditions[0].object.ne.terms*.text == ['Switzerland']
...
label:064 contents:sport contents:events contents:"Switzerland" woeid-index:23424957
"""
