 ...
 *
 */
 class GeoCLEF_EN_2006_043_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2006_043_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:043 Scientific research in universities of New England"
/*		
...
*/
		...
		assert question.sentence*.text == ['Scientific','research','in','universities','of','New','England']
	...
	// check detected NEs 
		...
		assert question.nes[0].terms*.text == ['New','England']
	...
	// check conditions 
		...
		assert question.conditions[0].object.geoscopeTerms*.text == ['New','England']
