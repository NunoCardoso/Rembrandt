 ...
 *
 */
 class GeoCLEF_PT_2008_087_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2008_087_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:087 Desemprego nos países da OCDE"// Sul" 
/*
...
*/
		...
		assert question.sentence*.text == ['Desemprego','nos','países','da','OCDE']
...
//		assert question.nes[1].classification.find{it == SC.place_human_division}
	...
	// check subjects 
	// games is grounded
		assert question.subject.subjectTerms*.text == ['países']
...
label:087 contents:Desemprego contents:"países" contents:"OCDE" entity:Organisation_for_Economic_Co-operation_and_Development
"""
