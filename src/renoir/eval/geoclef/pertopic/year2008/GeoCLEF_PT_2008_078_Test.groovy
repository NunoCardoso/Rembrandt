 ...
 *
 */
 class GeoCLEF_PT_2008_078_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2008_078_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:078 eventos desportivos no deserto do Sahara" 
...
*/
		...
		assert question.sentence*.text == ['eventos','desportivos','no','deserto','do','Sahara']
...
label:078 contents:eventos contents:desportivos contents:deserto contents:Sahara entity:Sahara
"""
