 ...
 * @author Nuno Cardoso
 */
class QualEAPopulacaoDePortugalTest extends GroovyTestCase {
	...
	public QualEAPopulacaoDePortugalTest() {
		// initialize
	...
	void testQualEAPopulacaoDePortugal() {

		// **** 4. Qual é a população de Portugal? ***
		String line = """
	...
	"""
		...
		assert c.predicate.terms[0].text == "popula\u00e7\u00e3o"
		assert c.predicate.terms[0].lemma == "popula\u00e7\u00e3o"
		...
		// qd.query(q)
		assert q.answer == ["10617575"], "Question answer is ${q.answer}"
