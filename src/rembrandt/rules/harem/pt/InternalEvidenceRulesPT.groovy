 ...
 */
class InternalEvidenceRulesPT extends NamedEntityDetector {
     ...
     * Main constructor
     */
    public InternalEvidenceRulesPT() {
	    
	rules = []

	rules.add(new Rule(id:"InternalEvidenceRulePT 1", clauses:[NEGazetteer.ie_meaningsPT1c] ))				
