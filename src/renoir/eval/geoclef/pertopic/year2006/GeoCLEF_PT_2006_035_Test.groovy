 ...
 *
 */
 class GeoCLEF_PT_2006_035_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2006_035_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:035 Empréstimos ao antigo Bloco de Leste"
		...
		assert question.sentence*.text == ['Empréstimos','ao','antigo','Bloco','de','Leste']
	...
	// check detected NEs 
		...
		//assert question.nes[0].terms*.text == ['Bloco','de','Leste']
...
label:035 contents:Empréstimos contents:antigo contents:Bloco contents:Leste
"""
