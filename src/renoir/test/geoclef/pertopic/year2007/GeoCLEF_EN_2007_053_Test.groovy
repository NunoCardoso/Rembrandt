 ...
 *
 */
 class GeoCLEF_EN_2007_053_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2007_053_Test() {
    ...
    void testTopic() {
		String lang = "en"
	//	String topic = "label:053 Scientific research at east coast Scottish universities"
		String topic = "label:053 Scientific research in the Scottish universities"
...
*/
		...
		assert question.sentence*.text == ['Scientific','research','in','the','Scottish','universities']
	...
	//	assert question.nes[0].terms*.text == ['Scottish']
	...
	// check conditions 
		...
		//assert question.conditions[0].operator.op == Operator.Locator.East
		assert question.conditions[0].object.subjectTerms*.text == ['universities']
		assert question.conditions[0].object.geoscopeTerms*.text == ['Scottish']
...
label:052 contents:crime contents:"St Andrews" woeid-index:35567
"""
