 ...
 *
 */
 class GeoCLEF_PT_2007_057_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2007_057_Test() {
    ...
    void testTopic() {
		String lang = "pt"
//		String topic = "label:057 Uísque de ilhas escocesas"
		String topic = "label:057 Uísque ou Whiskey nas ilhas da Escócia"
/*
label:057 
...
*/
		...
		assert question.sentence*.text == ['Uísque','ou','Whiskey','nas','ilhas','da','Escócia']
		assert question.questionType == QuestionType.None
		assert question.questionTypeTerms.size() == 0

	// check detected NEs 
		assert question.nes.size() == 1
		assert question.nes[0].terms*.text == ['Escócia']
