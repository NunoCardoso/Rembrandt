 ...
 *
 */
 class GeoCLEF_PT_2006_036_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2006_036_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:036 indústria automóvel no Mar do Japão"
...
*/
		...
		assert question.sentence*.text == ['indústria','automóvel','no','Mar','do','Japão']
	...
	// check detected NEs 
		...
		assert question.nes[0].terms*.text == ['Mar','do','Japão']
	...
	// check conditions 
		...
		assert question.conditions[0].object.ne.terms*.text == ['Mar','do','Japão']
