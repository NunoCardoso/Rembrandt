...
class I18n {
 ...
 // name of static variables canNOT have uppercase letters
    ...
    this.statslabel = [
      ...
      "numberdocs":["pt":"Número de documentos", "en":"Number of documents"],
   ...
   this.servermessage = [
      ...
      'error_deleting_doc':["pt":"Erro ao apagar o documento","en":"Error deleting document"],           
      ...
      'error_getting_doc':["pt":"Erro ao obter o documento","en":"Error getting document"],           
      'error_getting_doc_list':["pt":"Erro ao obter lista de documentos","en":"Error getting document list"],           
     	'error_getting_doc_metadata':["pt":"Erro ao obter matadata do documento","en":"Error getting metadata from tagged document"],           
      'error_getting_doc':["pt":"Erro ao obter o documento","en":"Error getting document"],           
      'error_getting_doc_list':["pt":"Erro ao obter lista de documentos","en":"Error getting document list"],           
      ...
      'error_updating_doc':["pt":"Erro durante a modificação de documento","en":"Error updating document"],           
