 ...
 *
 */
 class GeoCLEF_EN_2006_027_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2006_027_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:027 cities within 100 km of Frankfurt"
		...
		assert question.sentence*.text == ['cities','within','100','km','of','Frankfurt']
