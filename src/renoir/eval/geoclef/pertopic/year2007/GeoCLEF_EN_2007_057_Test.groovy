 ...
 *
 */
 class GeoCLEF_EN_2007_057_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2007_057_Test() {
    ...
    void testTopic() {
		String lang = "en"
	//	String topic = "label:057 Whisky making in the Scottish Islands"
		String topic = "label:057 Whisky making in the islands of Scotland"
...
*/
		...
		assert question.sentence*.text == ['Whisky','making','in','the','islands','of','Scotland']
