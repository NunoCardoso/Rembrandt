 ...
 */
public class LocalRulesPTTest extends RulesTest {
    
    static String path = Configuration.newInstance().get("rembrandt.home.dir",".")
    
    public LocalRulesPTTest() {	  
        super("pt","harem", path+"/resources/test/ExternalEvidencePT_Local.txt",
        path+"/resources/test/ExternalEvidencePT_Local_output.txt"
