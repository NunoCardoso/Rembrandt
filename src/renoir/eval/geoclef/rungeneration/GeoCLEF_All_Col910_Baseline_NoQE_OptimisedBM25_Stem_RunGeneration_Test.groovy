 ...
 *
 */
class GeoCLEF_All_Col910_Baseline_NoQE_OptimisedBM25_RunGeneration_Stem_Test extends GroovyTestCase {
    ...
    public GeoCLEF_All_Col910_Baseline_NoQE_OptimisedBM25_RunGeneration_Stem_Test() {}
    ...
    public GeoCLEF_Baseline_NoQE_RunGeneration_Test create(year, collection_id, lang) {
		...
		"GeoCLEF_${lang.toUpperCase()}_${year}_${type}.query", 
