 ...
 */
public class HTMLReaderAndHTMLWriterTest extends GroovyTestCase {
     ...
     public HTMLReaderAndHTMLWriterTest() {
	reader = new HTMLDocumentReader(new HTMLStyleTag("pt"))
	writer = new HTMLDocumentWriter(new HTMLStyleTag("pt"))
	core = new RembrandtCorePTforHAREM(conf)	
	File f = new File(conf.get("rembrandt.home.dir",".")+"/resources/test/HTML_PT_sample.txt")
	File f2 = new File(conf.get("rembrandt.home.dir",".")+"/resources/test/HTML_PT_sample_HTML_output.txt")
