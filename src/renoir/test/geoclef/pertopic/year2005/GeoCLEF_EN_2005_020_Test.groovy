 ...
 */
 class GeoCLEF_2005_EN_020_Test extends GroovyTestCase {
    ...
    void testTopic() {
		...
		assert question.sentence*.text == ['Wind','power','in','the','islands','of','Scotland']
