...
países	país	N	0	P	M	SUBJ>	0
têm	ter	V_fmc	PR_IND	3P	0	FMV	0
...
"""
	 ...
	 assert q.subject.terms*.text == ["países"], "Got ${q.subject.terms*.text} instead"
...
//cl_from = page_id and cl_to LIKE "Países%" and page_namespace=0 order by page_id
// tudo acima de 1000000 não vale a pena.
