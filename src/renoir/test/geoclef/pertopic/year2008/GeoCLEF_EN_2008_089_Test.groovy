 ...
 *
 */
 class GeoCLEF_EN_2008_089_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2008_089_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:089 trade fairs in Lower Saxony"
/*
...
*/
		...
		assert question.sentence*.text == ['trade','fairs','in','Lower','Saxony']
...
//		assert question.nes[0].classification.find{it == SC.organization}
		assert question.nes[0].terms*.text == ['Lower','Saxony']
