 ...
 *
 */
 class GeoCLEF_EN_2008_090_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2008_090_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:090 Environmental pollution in European waters"
	//	String topic = "label:090 Environmental pollution on seas and in rivers of Europe"
/*
...
*/
		...
		assert question.sentence*.text == ['Environmental','pollution','in','European','waters']
