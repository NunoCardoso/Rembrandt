 ...
 *
 */
 class GeoCLEF_2005_EN_010_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    
    public GeoCLEF_2005_EN_010_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:010 flooding in Holland and Germany"
		...
		assert question.sentence*.text == ['flooding','in','Holland','and','Germany']
	...
	// check detected NEs 
		...
		assert question.nes[0].terms*.text == ["Holland"]
	...
	// check conditions 
		...
		assert question.conditions[0].object.ne.terms*.text == ["Holland"]
...
label:010 contents:flooding contents:"Holland" contents:"Germany" 
woeid-index:23424977 woeid-index:23424829
"""		
