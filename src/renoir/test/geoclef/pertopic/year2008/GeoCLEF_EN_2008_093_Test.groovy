 ...
 *
 */
 class GeoCLEF_EN_2008_093_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2008_093_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:093 attacks in subways in Japan"
/*
...
*/
		...
		assert question.sentence*.text == ['attacks','in','subways','in','Japan']
