...
class ImportPlainText extends Import  {

	public ImportPlainText() {
		super()
	...
	public importer() {
		...
		while (docs) {
			...
			docs.each{doc ->
				...
				Doc d = addDoc(doc.docid, content, doc.lang, date_created, "")
	...
	static void main(args) {
		...
		ImportPlainText importer = new ImportPlainText()
