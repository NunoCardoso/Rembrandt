 ...
 * @author Nuno Cardoso
 */
class GeoCLEF_2006_EN_Baseline_NoQE_RunGeneration_Test extends GeoCLEF_Baseline_NoQE_RunGeneration_Test {
    ...
    public GeoCLEF_2006_EN_Baseline_NoQE_RunGeneration_Test() {
