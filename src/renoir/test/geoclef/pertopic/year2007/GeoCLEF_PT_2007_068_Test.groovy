 ...
 *
 */
 class GeoCLEF_PT_2007_068_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2007_068_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:068 Rios com cheias"
/*
...
*/
		...
		assert question.sentence*.text == ['Rios','com','cheias']
		assert question.questionType == QuestionType.None
		assert question.questionTypeTerms.size() == 0

	// check detected NEs 
		assert question.nes.size() == 1
		assert question.nes[0].terms*.text == ['Rios']
...
label:068 contents:"Rios" contents:cheias entity:Rivers
"""
