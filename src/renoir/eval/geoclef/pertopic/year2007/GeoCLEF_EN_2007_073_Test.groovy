 ...
 *
 */
 class GeoCLEF_EN_2007_073_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2007_073_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:073 Events at St. Paul's Cathedral"
/*
...
*/
		...
		assert question.sentence*.text == ['Events','at','St.','Paul','\'s','Cathedral']
...
// http://dbpedia.org/page/Bosphorus não tem classe, e QWikipédia não ajuda
	...
	// check detected NEs 
		...
		assert question.nes[1].terms*.text == ['Cathedral']
		assert question.nes[1].classification.find{it == SC.place_human_construction}
