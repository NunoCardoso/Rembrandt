 ...
 */
class Pagico_Statistic_BRF_QueryGeneration extends Pagico_QueryGeneration {
    ...
    public Pagico_Statistic_BRF_QueryGeneration(topic_file, query_file, collection, lang, Boolean stem) {
	...
	def o = new Pagico_Statistic_BRF_QueryGeneration(
