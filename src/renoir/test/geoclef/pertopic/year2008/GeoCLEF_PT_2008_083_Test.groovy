 ...
 *
 */
 class GeoCLEF_PT_2008_083_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2008_083_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:083 Manifestações contra o terrorismo no Norte de África" 
/*
...
*/
		...
		assert question.sentence*.text == ['Manifestações','contra','o','terrorismo','no','Norte','de','África']
...
// Sahara is grounded to Deserto do Saara, but can't make a NE out of it.
	...
	// check detected NEs 
		...
		assert question.nes[0].terms*.text == ['Norte','de','África']
...
*/		assert question.conditions[0].object instanceof QueryGeoscope
		assert question.conditions[0].operator.op == Operator.Locator.In
		assert question.conditions[0].object.ne.terms*.text == ['Península','Ibérica']
...
label:083 contents:Manifestações contents:contra contents:terrorismo contents:Norte contents:África  woeid-index:24865722 woeid-index:23424740 woeid-index:23424802 woeid-index:23424882 woeid-index:23424893 woeid-index:23424952 woeid-index:23424967 woeid-index:23424990
