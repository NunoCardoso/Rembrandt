 ...
 *
 */
 class GeoCLEF_EN_2006_044_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2006_044_Test() {
    ...
    void testTopic() {
		String lang = "en"
//		String topic = "label:044 Arms sales in former Yugoslavia"
		String topic = "label:044 Arms sales in Yugoslavia"
	/*		
...
//		assert question.sentence*.text == ['Arms','sales','in','former','Yugoslavia']
		assert question.sentence*.text == ['Arms','sales','in','Yugoslavia']
	...
	// check detected NEs 
		...
		assert question.nes[0].terms*.text == ['Yugoslavia']
	...
	// check conditions 
		...
		assert question.conditions[0].object.ne.terms*.text == ['Yugoslavia']
