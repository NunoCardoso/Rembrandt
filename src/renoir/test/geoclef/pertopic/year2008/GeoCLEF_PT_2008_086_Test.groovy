 ...
 *
 */
 class GeoCLEF_PT_2008_086_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2008_086_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:086 Monumentos mais visitados na região da capital de França"// Sul" 
/*
...
*/
		...
		assert question.sentence*.text == ['Monumentos','mais','visitados','na','região','da','capital','de','França']
...
// Sahara is grounded to Deserto do Saara, but can't make a NE out of it.
	...
	// check detected NEs 
		...
		assert question.nes[0].terms*.text == ['França']
