 ...
 *
 */
 class GeoCLEF_EN_2008_088_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2008_088_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:088 Portuguese immigrant communities in the world"
/*
...
*/
		...
		assert question.sentence*.text == ['Portuguese','immigrant','communities','in','the','world']
...
//		assert question.nes[0].classification.find{it == SC.organization}
	...
	// check subjects 
		...
		assert question.subject.subjectTerms*.text == ['communities']
...
*/			
	// Then, for the lone condition Subject, we resolve it and add it 			
		assert question.expectedAnswerTypes[0].DBpediaOntologyResources == ['Category:Communities']
...
label:088 contents:Portuguese contents:immigrant contents:"communities" contents:world 
"""
