 ...
 */
class TestQualEANacionalidadeDeJoseSaramago extends GroovyTestCase {
	...
	public TestQualEANacionalidadeDeJoseSaramago() {
		// initialize
...
void testQualEANacionalidadeDeJoseSaramago() {
	...
	// qd.query(q)
	 assert q.answer == ["http://dbpedia.org/resource/Portugal"], "Question answer is ${q.answer}"
