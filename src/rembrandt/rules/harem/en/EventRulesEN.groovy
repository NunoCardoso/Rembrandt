...
import rembrandt.gazetteers.en.EventGazetteerEN
 ...
 */
class EventRulesEN extends NamedEntityDetector {
    ...
    public EventRulesEN() {
        ...
        // 1 {<EM>!} cerimony
        rules.add(new Rule(id:"EventRulesEN 1", description:" {<EM>!} cerimony!", sc:SC.event_organized,
        policy:RulePolicy.Clause, clauses:[ 
                NEGazetteer.NE_Anything_1c, 
                EventGazetteerEN.event1nc
         ] ))				
    }
}