 ...
 *
 */
 class GeoCLEF_EN_2007_061_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2007_061_Test() {
    ...
    void testTopic() {
		String lang = "en"
//		String topic = "label:061 Airplane crashes close to Russian cities"
		String topic = "label:061 Airplane crashes near cities of Russia"
/*
...
*/
		...
		assert question.sentence*.text == ['Airplane','crashes','near','cities','of','Russia']
...
//		assert question.nes[0].terms*.text == ['Airplane']
//		assert question.nes[0].classification.find{it == SC.thing_object}
		assert question.nes[0].terms*.text == ['Russia']
