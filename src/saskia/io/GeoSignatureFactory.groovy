           ...
           // println "ne: $ne"
            ...
            if (e.ent_dbpedia_class && dbpediaontology.isAPlace(e.ent_dbpedia_class)) {
                ...
                if (geo) {
                	...
                	geo = Geoscope.getNewGeoscopeForPlacename(ne.name)                    
                	log.info "No Geoscope associated to Entity ${e.ent_id}, name ${ne.name}, used GeoPlanet to get a new one"
                        if (!geo || !geo.geo_name) {
                            ...
                            if (geo2 && geo2.geo_id) {
                                ...
                                geo2 = Geoscope.getFromWOEID(geo.geo_woeid)
                                if (geo2) {
                    ...
                    if (!geo.isACountry()) {
                        ...
                        ancestor_woeids.each{ancestor_woeid -> 
                          ...
                          if (ancestor) {
                             ...
                             try {
                        	 ancestor = Geoscope.fetchPlaceForWOEID(ancestor_woeid)
