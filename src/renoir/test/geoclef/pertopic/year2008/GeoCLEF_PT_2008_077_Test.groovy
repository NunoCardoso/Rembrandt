 ...
 *
 */
 class GeoCLEF_PT_2008_077_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2008_077_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:077 prémios Nobel nascidos no Norte da Europa" 
...
*/
		...
		assert question.sentence*.text == ['prémios','Nobel','nascidos','no','Norte','da','Europa']
	...
	// check detected NEs 
		...
		assert question.nes[0].terms*.text == ['Nobel']
		assert question.nes[0].classification.find{it == SC.thing_class}
	//	assert question.nes[0].terms*.text == ['Norte','da','Europa']
...
//		assert question.conditions[0].object instanceof QueryGeoscope
	...
	//	assert question.conditions[0].object.ne.terms*.text == ['Norte','da','Europa']
...
label:077 contents:prémios contents:"Nobel" contents:nascidos contents:Norte contents:Europa ne-COISA-CLASSE-index:"Nobel" woeid-index:55949067 woeid-index:23424796 woeid-index:23424812 woeid-index:23424845 woeid-index:23424910 woeid-index:23424954 woeid-index:23424805 woeid-index:23424874 woeid-index:23424757 woeid-index:23424909 woeid-index:23424881 woeid-index:23424845 woeid-index:23424875 woeid-index:23424975 woeid-index:23424829 woeid-index:23424923 woeid-index:23424936
"""
