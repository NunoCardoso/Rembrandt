 ...
 *
 */
 class GeoCLEF_PT_2007_065_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2007_065_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:065 Eleições livres em África"
/*
...
*/
		...
		assert question.sentence*.text == ['Eleições','livres','em','África']
