 ...
 *
 */
 class GeoCLEF_EN_2007_072_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2007_072_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:072 beaches with sharks"
/*
...
*/
		...
		assert question.sentence*.text == ['beaches','with','sharks']
...
label:072 contents:beaches contents:sharks
"""
