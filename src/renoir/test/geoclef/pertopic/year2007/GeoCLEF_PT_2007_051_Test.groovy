 ...
 *
 */
 class GeoCLEF_PT_2007_051_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2007_051_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:051 Extracção de petróleo e gás entre o Reino Unido e o continente europeu" 

/*
label:052 Crime perto de Santo André
...
*/
		...
		assert question.sentence*.text == ['Extracção','de','petróleo','e','gás','entre','o','Reino','Unido','e','o','continente','europeu']
	...
	// Wikipedia does not help, either.
		...
		assert question.nes[0].terms*.text == ['Reino','Unido']
	...
	// check conditions 
		...
		assert question.conditions[0].object.ne.terms*.text == ['Reino','Unido']
