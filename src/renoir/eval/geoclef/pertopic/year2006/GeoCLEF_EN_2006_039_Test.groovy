 ...
 *
 */
 class GeoCLEF_EN_2006_039_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2006_039_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:039 Russian troops in the southern Caucasus"
...
*/
		...
		assert question.sentence*.text == ['Russian','troops','in','the','southern','Caucasus']
