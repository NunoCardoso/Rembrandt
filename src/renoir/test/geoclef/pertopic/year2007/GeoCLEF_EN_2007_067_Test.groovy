 ...
 *
 */
 class GeoCLEF_EN_2007_067_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2007_067_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:067 F1 circuits where Ayrton Senna competed in 1994"
/*
...
*/
		...
		assert question.sentence*.text == ['F1','circuits','where','Ayrton','Senna','competed','in','1994']
...
/*		
		...
		assert question.conditions[0].object.ne.terms*.text == ['Bosphorous']
	*/	
