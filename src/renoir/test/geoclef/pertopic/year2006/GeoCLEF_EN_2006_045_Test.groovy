 ...
 *
 */
 class GeoCLEF_EN_2006_045_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2006_045_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:045 tourism in northeast Brazil"
/*		
...
*/
		...
		assert question.sentence*.text == ['tourism','in','northeast','Brazil']
	...
	// check detected NEs 
		...
		assert question.nes[0].terms*.text == ['Brazil']
	...
	// check conditions 
		...
		assert question.conditions[0].object.ne.terms*.text == ['Brazil']
