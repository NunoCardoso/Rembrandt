 ...
 */
class ImportCLEFCollectionEN2SourceDocument {
	...
	public ImportCLEFCollectionEN2SourceDocument(String filename) {

	    conf = Configuration.newInstance()
	    collection = Collection.getFromName("Los Angeles Times 94 e Glasgow Herald 95")	    
	    if (!collection) 
	...
	public HashMap importDocs() {
	    ...
	    // 
	    // in LAT, titles are LA010194-0001
	    // it is the first paragraph. MOVE it to the title
	    //
	    // in GH95, titles are GH950102-000000
	    // let's check if first sentence does not exceed 70 characters, 
	    // and does not end in [.!?]. If then, move it
	    //
	    ...
	    // on the header, use: <DOC DOCID="original_doc_id" LANG="en" TAGLANG="pt">
	...
	static void main(args) {
	    ...
	    println "Recommended usage: java -server -Xms128m -Xmx256m -Dfile.encoding=UTF-8 saskia.imports.ImportCLEFCollectionEN2SourceDocument --file=/home/user/GH9501_UTF8.txt"
	    ...
	    ImportCLEFCollectionEN2SourceDocument w2s = new ImportCLEFCollectionEN2SourceDocument(
