 ...
 *
 */
 class GeoCLEF_EN_2007_052_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2007_052_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:052 crime near St Andrews"
...
*/
		...
		assert question.sentence*.text == ['crime','near','St','Andrews']
	...
	// check detected NEs 
		...
		assert question.nes[0].terms*.text == ['St','Andrews']
	...
	// check conditions 
		...
		assert question.conditions[0].object.ne.terms*.text == ['St','Andrews']
