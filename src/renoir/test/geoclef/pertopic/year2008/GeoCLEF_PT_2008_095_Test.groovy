 ...
 *
 */
 class GeoCLEF_PT_2008_095_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2008_095_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:095 Tropas americanas no Golfo Pérsico"
/*
...
*/
		...
		assert question.sentence*.text == ['Tropas','americanas','no','Golfo','Pérsico']
...
// Sahara is grounded to Deserto do Saara, but can't make a NE out of it.
	...
	// check detected NEs 
		...
		assert question.nes[0].terms*.text == ['Golfo','Pérsico']
...
*/	
		...
		assert question.conditions[0].operator.op == Operator.Locator.In
		assert question.conditions[0].object.ne.terms*.text == ['Golfo','Pérsico']
