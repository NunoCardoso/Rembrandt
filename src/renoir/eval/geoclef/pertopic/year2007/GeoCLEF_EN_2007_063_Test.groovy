 ...
 *
 */
 class GeoCLEF_EN_2007_063_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2007_063_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:063 Water quality along coastlines in the Mediterranean Sea"
/*
...
*/
		...
		assert question.sentence*.text == ['Water','quality','along','coastlines','in','the','Mediterranean','Sea']
...
*/		
		...
		assert question.conditions[0].object.ne.terms*.text == ['Mediterranean','Sea']
