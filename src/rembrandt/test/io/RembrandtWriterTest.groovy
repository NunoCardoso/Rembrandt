 ...
 *
 */
class RembrandtWriterTest extends WriterTest {


	public RembrandtWriterTest() {
		super()
		this.writer = new RembrandtWriter(new RembrandtStyleTag("pt"))
	...
	void testWriterTaggedRembrandt() {
		this.file_input = conf.get("rembrandt.home.dir") + fileseparator + "resources" +
