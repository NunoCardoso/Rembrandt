 ...
 *
 */
 class GeoCLEF_EN_2008_095_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2008_095_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:095 American troops in the Persian Gulf"
/*
...
*/
		...
		assert question.sentence*.text == ['American','troops','in','the','Persian','Gulf']
		assert question.questionType == QuestionType.None
		assert question.questionTypeTerms.size() == 0

	// check detected NEs 
		assert question.nes.size() == 1
		assert question.nes[0].terms*.text == ['Persian','Gulf']
...
*/	
		...
		assert question.conditions[0].operator.op == Operator.Locator.In
		assert question.conditions[0].object.ne.terms*.text ==  ['Persian','Gulf']
...
label:094 contents:Demonstrations contents:German contents:"cities" woeid-index:23424829
"""
