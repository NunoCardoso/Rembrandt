 ...
 *
 */
 class GeoCLEF_EN_2008_079_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2008_079_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:079 invasion of East Timor's capital by Indonesia"
...
*/
		...
		assert question.sentence*.text == ['invasion','of','East','Timor','\'s','capital','by','Indonesia']
	...
	// check detected NEs 
		...
		assert question.nes[0].terms*.text == ['East','Timor']
		assert question.nes[0].classification.find{it == SC.place_human_country}
		assert question.nes[1].terms*.text == ['Indonesia']
