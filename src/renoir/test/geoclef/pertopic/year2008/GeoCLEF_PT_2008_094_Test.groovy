 ...
 *
 */
 class GeoCLEF_PT_2008_094_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2008_094_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:094 Manifestações em cidades alemãs"
/*
...
*/
		...
		assert question.sentence*.text == ['Manifestações','em','cidades','alemãs']
