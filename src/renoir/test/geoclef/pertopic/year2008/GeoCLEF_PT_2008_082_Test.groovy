 ...
 *
 */
 class GeoCLEF_PT_2008_082_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2008_082_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:082 Agricultura na Península Ibérica" 
/*
...
*/
		...
		assert question.sentence*.text == ['Agricultura','na','Península','Ibérica']
...
// Sahara is grounded to Deserto do Saara, but can't make a NE out of it.
	...
	// check detected NEs 
		...
		assert question.nes[0].terms*.text == ['Agricultura']
