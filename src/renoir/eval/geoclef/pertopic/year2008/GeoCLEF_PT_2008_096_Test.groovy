 ...
 *
 */
 class GeoCLEF_PT_2008_096_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2008_096_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:096 boom económico no Sueste Asiático"
/*
...
*/
		...
		assert question.sentence*.text == ['boom','económico','no','Sueste','Asiático']
...
/*		assert question.nes[0].terms*.text == ['Sueste','Asiático']
...
/*		assert question.conditions[0].object instanceof QueryGeoscope
		assert question.conditions[0].operator.op == Operator.Locator.In
		assert question.conditions[0].object.ne.terms*.text == ['Sueste','Asiático']
*/	
