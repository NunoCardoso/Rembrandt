 ...
 * @author Nuno Cardoso
 */
class TestEmQueCidadeFicaSituadaATorreEiffel extends GroovyTestCase {
	...
	public TestEmQueCidadeFicaSituadaATorreEiffel() {
		// initialize
...
""" 
	 ...
	 assert sentence*.type == ["PRP","DET","N","V","V","DET","PROP","PROP","PONT"], \
	 ...
	 assert q.subject.ontologyDBpedia == ['http://dbpedia.org/ontology/City'], \
...
//	 qd.query(q)
	 assert q.answer == ["http://dbpedia.org/resource/Paris"], \
