 ...
 *
 */
class NTCIR_All_Col7_Baseline_NoQE_StandardBM25_NoStem_RunGeneration_Test extends GroovyTestCase {
 
    Configuration conf
    static Logger log = Logger.getLogger("RenoirTest")
	 static String col = "Col7"
	 static int coln = 7	
	 static String type ="Baseline_NoQE"
	 static String model ="StandardBM25"
	 static String dostem ="NoStem"	
    static Boolean stem = false
	 
    public NTCIR_All_Col7_Baseline_NoQE_StandardBM25_NoStem_RunGeneration_Test() {}
    
    public NTCIR_Baseline_NoQE_RunGeneration_Test create(year, collection_id, lang) {
		...
		"NTCIR_${lang.toUpperCase()}_${year}_${col}_${type}_${model}_${dostem}.run", 
		Collection.getFromID(collection_id), lang, stem)
    }
    
     void testNTCIR2010EN() {
    	NTCIR_Baseline_NoQE_RunGeneration_Test o = create(2010, coln, 'en')
		o.generate()
	}

/* "_10")
	   o.generateWithWeight(1.0f, 1.0f, 1.0f)
	 	o = create(2010, col, 'en', "_05")
	   o.generateWithWeight(1.0f, 0.5f, 0.5f)	
	 	o = create(2010, col, 'en', "_02")
	   o.generateWithWeight(1.0f, 0.2f, 0.2f)	
	 	o = create(2010, col, 'en', "_01")
	   o.generateWithWeight(1.0f, 0.1f, 0.1f)	
	 	o = create(2010, col, 'en', "_001")
	   o.generateWithWeight(1.0f, 0.01f, 0.01f)	
	 	o = create(2010, col, 'en', "_0001")
