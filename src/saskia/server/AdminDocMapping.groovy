 ...
 *
 */
public class AdminDocMapping extends WebServiceRestletMapping {
    ...
    public AdminDocMapping(SaskiaDB db) {
        ...
        JSONanswer = {req, par, bind ->
            ...
            if (action == "list") {
        		...
        		try {
                    h = Doc.listDocs(collection, limit, offset, column, value)
                } catch(Exception e) {
