 ...
 *
 */
 class GeoCLEF_PT_2008_093_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2008_093_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:093 Atentados em metropolitanos no Japão"
/*
...
*/
		...
		assert question.sentence*.text == ['Atentados','em','metropolitanos','no','Japão']
...
//		assert question.nes[0].classification.find{it == SC.place_human_division}
		assert question.nes[0].terms*.text == ['Japão']
...
*/	
		...
		assert question.conditions[0].operator.op == Operator.Locator.In
		assert question.conditions[0].object.ne.terms*.text == ['Japão']
