...
/** generate entity list DIV */
function generateEntityListDIV(response, su, role, options) {
...
function generateEntityShowDIV(response, su, role, options) {
...
function modalEntityDelete(button) {
