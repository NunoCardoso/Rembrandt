 ...
 *
 */
 class GeoCLEF_EN_2006_038_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2006_038_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:038 Solar or lunar eclipse in Southeast Asia"
...
*/
		...
		assert question.sentence*.text == ['Solar','or','lunar','eclipse','in','Southeast','Asia']
