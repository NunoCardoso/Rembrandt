 ...
 *
 */
 class GeoCLEF_EN_2006_029_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2006_029_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:029 Diamond trade in Angola and South Africa"
		...
		assert question.sentence*.text == ['Diamond','trade','in','Angola','and','South','Africa']
	...
	// check detected NEs 
		...
		assert question.nes[1].terms*.text == ['South','Africa']
	...
	// check conditions 
		...
		assert question.conditions[1].object.ne.terms*.text == ['South','Africa']
...
label:029 contents:Diamond contents:trade contents:"Angola" contents:"South Africa" woeid-index:23424745 woeid-index:23424942
"""		
