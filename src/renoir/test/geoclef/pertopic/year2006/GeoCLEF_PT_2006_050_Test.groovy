 ...
 *
 */
 class GeoCLEF_PT_2006_050_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2006_050_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:050 cidades no Danúbio e no Reno" 
...
*/
		...
		assert question.sentence*.text == ['cidades','no','Danúbio','e','no','Reno']
	...
	// Wikipedia does not help, either.
		...
		assert question.nes[0].terms*.text == ['Danúbio']
		assert question.nes[0].classification.find{it == SC.place_physical_watercourse}
		assert question.nes[1].terms*.text == ['Reno']
...
label:050 contents:"cidades" contents:"Danúbio" contents:"Reno" woeid-index:26354151 woeid-index:2635412
"""
