 ...
 *
 */
 class GeoCLEF_EN_2008_086_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2008_086_Test() {
    ...
    void testTopic() {
		String lang = "en"
//		String topic = "label:086 Most visited sights in the capital of France and its vicinity
		// cities is added to make a subject ground
		String topic = "label:086 most visited sights in the capital of France and its vicinity"
...
*/
		...
		assert question.sentence*.text == ['most','visited','sights','in','the','capital','of','France','and','its','vicinity']
...
//		assert question.nes[0].classification.find{it == SC.organization}
		assert question.nes[0].terms*.text == ['France']
