 ...
 *
 */
 class GeoCLEF_PT_2007_069_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2007_069_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:069 morte nos Himalaias"
/*
...
*/
		...
		assert question.sentence*.text == ['morte','nos','Himalaias']
		assert question.questionType == QuestionType.None
		assert question.questionTypeTerms.size() == 0

	// check detected NEs 
		assert question.nes.size() == 1
		assert question.nes[0].terms*.text == ['Himalaias']
...
//		assert question.conditions[0].object.geoscopeTerms*.text == ['Rússia']
		...
		assert question.conditions[0].object.ne.terms*.text ==  ['Himalaias']
...
label:069 contents:morte contents:"Himalaias" entity:Himalayas
"""
