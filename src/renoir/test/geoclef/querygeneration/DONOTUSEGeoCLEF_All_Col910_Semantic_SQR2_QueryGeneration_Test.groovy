 ...
 */
class DONOTUSEGeoCLEF_All_col910_Semantic_SQR2_OptimisedBM25_QueryGeneration_Test extends GroovyTestCase {

    Configuration conf = Configuration.newInstance()
    static Logger log = Logger.getLogger("RenoirTest")
    
    public DONOTUSEGeoCLEF_All_col910_Semantic_SQR2_OptimisedBM25_QueryGeneration_Test() {}
    ...
    public GeoCLEF_Semantic_SQR2_QueryGeneration_Test create(year, collection_id, lang) {
		...
		return new GeoCLEF_Semantic_SQR2_QueryGeneration_Test(
			...
			"GeoCLEF_${lang.toUpperCase()}_${year}_Col910_Semantic_SQR2_OptimisedBM25.query", 
			homedir+fileseparator+"index"+fileseparator+"col-"+collection_id, lang)
    }
    
    void testGeoCLEF2005EN() {
	GeoCLEF_Semantic_SQR2_QueryGeneration_Test o = create(2005, 10, 'en')
	// no opt parameters for this one
	o.generate()
    } 
    void testGeoCLEF2006EN() {
	GeoCLEF_Semantic_SQR2_QueryGeneration_Test o = create(2006, 10,'en')
      	//k1, b, term, doc
	o.generate(1.6d, 0.3d)
    }
    void testGeoCLEF2007EN() {
	GeoCLEF_Semantic_SQR2_QueryGeneration_Test o = create(2007, 10,'en')
	o.generate(1.4d, 0.65d)
    }
    void testGeoCLEF2008EN() {
	GeoCLEF_Semantic_SQR2_QueryGeneration_Test o = create(2008, 10,'en')
	o.generate(1.6d, 0.65d)
    }
    void testGeoCLEF2006PT() {
	GeoCLEF_Semantic_SQR2_QueryGeneration_Test o = create(2006, 9,'pt')
	o.generate(0.4d, 0.4d)
    }
    void testGeoCLEF2007PT() {
	GeoCLEF_Semantic_SQR2_QueryGeneration_Test o = create(2007, 9,'pt')
	o.generate(0.9d, 0.4d)
    }
    void testGeoCLEF2008PT() {
	GeoCLEF_Semantic_SQR2_QueryGeneration_Test o = create(2008, 9,'pt')
