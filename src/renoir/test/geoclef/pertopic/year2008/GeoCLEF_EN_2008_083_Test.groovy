 ...
 *
 */
 class GeoCLEF_EN_2008_083_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2008_083_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:083 Demonstrations against terrorism in Northern Africa"
...
*/
		...
		assert question.sentence*.text == ['Demonstrations','against','terrorism','in','Northern','Africa']
...
//		assert question.nes[0].classification.find{it == SC.organization}
		assert question.nes[0].terms*.text == ['Northern','Africa']
...
*/		assert question.conditions[0].object instanceof QueryGeoscope
		assert question.conditions[0].operator.op == Operator.Locator.In
		assert question.conditions[0].object.ne.terms*.text == ['Northern','Africa']
...
label:083 contents:Demonstrations contents:against contents:terrorism contents:"Northern Africa" woeid-index:24865722 woeid-index:23424740 woeid-index:23424802 woeid-index:23424882 woeid-index:23424893 woeid-index:23424952 woeid-index:23424967 woeid-index:23424990
"""
