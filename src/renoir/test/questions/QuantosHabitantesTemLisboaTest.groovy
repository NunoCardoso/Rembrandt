 ...
 */
class QuantosHabitantesTemLisboaTest extends GroovyTestCase {
	...
	public QuantosHabitantesTemLisboaTest() {
		// initialize
	...
	void testQuantosHabitantesTemLisboa() {
		...
		assert c.predicate.dbpedia_local_property == [
			"dbpedia2:popula_percent_E3_percent_A7_percent_E3_percent_A3o"
		], \
