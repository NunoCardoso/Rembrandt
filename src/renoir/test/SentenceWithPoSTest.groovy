 ...
 * @author Nuno Cardoso
 */
class TestSentenceWithPoS extends GroovyTestCase {

	def Logger log = Logger.getLogger("UnitTest")
	Configuration conf
	
	public TestSentenceWithPoS() {
		// initialize
	...
	"?"]
	 ...
	 SentenceWithPoS palavras_sentence = SentenceWithPoS.tokenizePoS(
  	 ...
  	 assert linguateca_sentence*.type == ["DET", "N", "V", "PROP","PONT"], \
		"linguateca_sentence.types = "+linguateca_sentence*.type
  	 assert palavras_sentence*.type == ["DET", "N", "V", "PROP","PONT"], \
	...
	void testSentence2() {
	 ...
	 SentenceWithPoS palavras_sentence = SentenceWithPoS.tokenizePoS(
		palavras_line, SentenceWithPoS.FROM_PALAVRAS_PoS)
  	 assert linguateca_sentence*.type == ["DET", "N", "V", "PROP","PROP","PONT"], \
		"linguateca_sentence.types = "+linguateca_sentence*.type
  	 assert palavras_sentence*.type == ["DET", "N", "V", "PROP","PROP","PONT"], \
		"palavras_sentence.types = "+palavras_sentence*.type
	}
	...
	?	?	PU	0	0	0	PONT	0
	"""
	List palavras_line = ["[quanto=pesa 		[quanto=pesa] DET M S @<SA", 
	"um 		[um] <arti> DET M S @>N", 
	"Ferrari=F40 		[Ferrari=F40] PROP M S @NPHR",
	"?"]
	List solution_linguateca = ["DET", "V", "DET","PROP","PROP","PONT"]
	// a resolver
	List solution_palavras = ["DET", "DET", "DET","PROP","PROP","PONT"]
	...
	List palavras_line = ["qual 		[qual] <interr> DET M/F S @SC>",
	...
	"?"]
	 ...
	 List solution = ["DET", "V", "DET","N", "PRP","PROP","PONT"]
...
"?"]
	 ...
	 List solution = ["DET", "V", "DET","N", "PRP","DET","PROP","PROP","PONT"]
...
"?"]
	 ...
	 List solution = ["DET", "V", "DET","N", "PRP","PROP","PROP","PONT"]
...
"?"]
	 ...
	 List solution_linguateca = ["DET", "DET","N", "PRP","N", "PRP","PROP","PONT"]
	 List solution_palavras = ["DET", "DET","N", "PRP","DET","N", "PRP","PROP","PONT"]
...
"?"]
	 ...
	 List solution = ["DET", "SPEC","V", "DET","PROP","PROP","PONT"]
...
"?"]
	 ...
	 List solution = ["DET","SPEC","V","DET","PROP","PONT"]
...
"?"]
	 ...
	 List solution = ["DET","SPEC","V","PROP","PROP","PONT"]
...
"?"]
	 ...
	 List solution = ["SPEC","V","PROP","PROP","PONT"]
...
"?"]
	 ...
	 List solution = ["PRP","DET","N","V","PROP","PONT"]
...
"?"]
	 ...
	 List solution = ["PRP","DET","N","V","PRP","PROP","PROP","PONT"]
...
"?"]
	 ...
	 List solution_linguateca = ["PRP","DET","N","V","V","DET","N","PROP","PONT"]
	 List solution_palavras = ["PRP","DET","N","V","V","DET","PROP","PROP","PONT"]
...
"?"]
	 ...
	 List solution = ["PRP","DET","N","V","PRP","PROP","PONT"]
...
"?"]
	 ...
	 List solution = ["ADV","V","PRP","PROP","PROP","PROP","PONT"]
...
"?"]
	 ...
	 List solution = ["ADV","V","PRP","PROP","PONT"]
...
"?"]
	 ...
	 List solution = ["ADV","V","PROP","PROP","PONT"]
...
"?"]
	 ...
	 List solution = ["ADV","PERS","V","DET","N","PRP","PROP","PONT"]
...
"?"]
	 ...
	 List solution = ["ADV","PERS","V","PROP","PROP","PONT"]
...
"?"]
	 ...
	 List solution = ["PRP","DET","N","V","PROP","PROP","PONT"]
