 ...
 */
class TestQualEAAlturaDeUmFerrariF40 extends GroovyTestCase {
	...
	public TestQualEAAlturaDeUmFerrariF40() {
		// initialize
...
//	 qd.query(q)
	 assert q.answer == ["1130^^http://dbpedia.org/ontology/millimetre"], \
