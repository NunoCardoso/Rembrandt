 ...
 *
 */
 class GeoCLEF_EN_2006_031_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2006_031_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:031 Combats and embargo in the northern part of Iraq"
/*
label:032 Independence movement in Quebec
label:033 International sports competitions in the Ruhr
label:034 Malaria vaccination outbreaks in the tropics 
label:035 Credits to the former Eastern Bloc 
label:036 Automotive car manufacturers around the Sea of Japan  
...
*/
		...
		assert question.sentence*.text == ['Combats','and','embargo','in','the','northern','part','of','Iraq']
	...
	// check detected NEs 
		...
		assert question.nes[0].terms*.text == ['Iraq']
	...
	// check conditions 
		...
		assert question.conditions[0].object.ne.terms*.text == ['Iraq']
