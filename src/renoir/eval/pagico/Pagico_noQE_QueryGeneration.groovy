 ...
 */
class Pagico_noQE_QueryGeneration extends Pagico_QueryGeneration {
    ...
    public Pagico_noQE_QueryGeneration(topic_file, query_file, collection, lang, Boolean stem) {
	...
	def o = new Pagico_noQE_QueryGeneration(
