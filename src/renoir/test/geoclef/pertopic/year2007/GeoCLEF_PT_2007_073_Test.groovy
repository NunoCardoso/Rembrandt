 ...
 *
 */
 class GeoCLEF_PT_2007_073_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2007_073_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:073 ocorrências na catedral de São Paulo"
/*
...
*/
		...
		assert question.sentence*.text == ['ocorrências','na','catedral','de','São','Paulo']
...
label:073 contents:ocorrências contents:catedral contents:"São Paulo" entity:S%C3%A3o_Paulo_%28state%29
"""
