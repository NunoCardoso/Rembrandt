 ...
 *
 */
 class GeoCLEF_PT_2007_071_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2007_071_Test() {
    ...
    void testTopic() {
		String lang = "pt"
//		String topic = "label:071 Problemas sociais na Grande Lisboa"
		String topic = "label:071 problemas sociais em Lisboa"
/*
...
*/
		...
		assert question.sentence*.text == ['problemas','sociais','em','Lisboa']
