 ...
 *
 */
 class GeoCLEF_PT_2007_074_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2007_074_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:074 tráfego marítimo nas ilhas portuguesas"
/*
...
*/
		...
		assert question.sentence*.text == ['tráfego','marítimo','nas','ilhas','portuguesas']
		assert question.questionType == QuestionType.None
		assert question.questionTypeTerms.size() == 0

	// check detected NEs 
		assert question.nes.size() == 0
//		assert question.nes[0].terms*.text == ['São','Paulo']
...
label:074 contents:tráfego contents:marítimo contents:ilhas contents:portuguesas entity:Sabrina_Island_%28Azores%29 entity:Dom_Jo%C3%A3o_de_Castro_Bank entity:Corvo_Island entity:Dollabarat entity:Formigas entity:Monchique_Islet entity:Culatra_Island entity:Barreta_Island entity:Armona_Island entity:Tavira_Island entity:Cacela_Island entity:Berlenga_Grande_Island entity:Berlengas woeid-index:742198 entity:Bugio_Island entity:Deserta_Grande_Island entity:Cal_Islet entity:Ilh%C3%A9u_Ch%C3%A3o entity:Selvagem_Grande_Island woeid-index:12478424 entity:Selvagem_Pequena_Island entity:Ermal_Island entity:Pessegueiro_Island  entity:Terceira_Island entity:Santa_Maria_Island entity:São_Miguel_Island entity:Flores_Island_%28Azores%29 entity:Graciosa_Island_%28Azores%29 entity:Pico_Island entity:São_Jorge_Island entity:Faial_Island entity:Madeira_Island entity:Savage_Islands entity:Porto_Santo_Island"""
