 ...
 *
 */
 class GeoCLEF_PT_2006_042_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2006_042_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:042 Eleições regionais no norte da Alemanha"
...
*/
		...
		assert question.sentence*.text == ['Eleições','regionais','no','norte','da','Alemanha']
	...
	// check detected NEs 
		...
		assert question.nes[0].terms*.text == ['Alemanha']
	...
	// check conditions 
		...
		assert question.conditions[0].object.ne.terms*.text == ['Alemanha']
...
label:042 contents:Eleições contents:regionais contents:norte contents:"Alemanha" woeid-index:23424829
"""
