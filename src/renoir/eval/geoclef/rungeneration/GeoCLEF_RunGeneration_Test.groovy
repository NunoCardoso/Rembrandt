 ...
 *
 */
class GeoCLEF_RunGeneration_Test extends GroovyTestCase {
    ...
    public GeoCLEF_RunGeneration_Test(String query_file, String qrel_file, String run_file, 
 ...
 // initialize by reading the topics and qrels
	...
	queryfile = homedir+fileseparator+"resources"+fileseparator+"eval"+
            fileseparator+"geoclef"+fileseparator+"queries"+fileseparator+query_file
        qrelfile = homedir+fileseparator+"resources"+fileseparator+"eval"+
            fileseparator+"geoclef"+fileseparator+"qrels"+fileseparator+qrel_file
        runfile = homedir+fileseparator+"resources"+fileseparator+"eval"+
            fileseparator+"geoclef"+fileseparator+"runs"+fileseparator+run_file
        logfile = homedir+fileseparator+"resources"+fileseparator+"eval"+
            fileseparator+"geoclef"+fileseparator+"logs"+fileseparator+run_file+".log"
