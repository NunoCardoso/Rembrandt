 ...
 *
 */
 class GeoCLEF_EN_2007_060_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2007_060_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:060 casualties in fights in Nagorno-Karabakh"// (CAN)"
/*
...
*/
		...
		assert question.sentence*.text == ['casualties','in','fights','in','Nagorno','-','Karabakh']
	...
	// check subjects 
	// games is grounded
		assert question.subject.subjectTerms*.text == ['casualties']
	...
	// Then, for the lone condition Subject, we resolve it and add it 			
		assert question.expectedAnswerTypes[0].DBpediaOntologyResources != null
...
// Couldn't find Nagorno Karabavk in GeoPlanet!!!!

		println refq.toString()
		String reformulated_x = """
label:060 contents:"casualties" contents:fights contents:"Nagorno - Karabakh" entity:Nagorno-Karabakh
