...
class I18n {
 ...
 // name of static variables canNOT have uppercase letters
   ...
   this.servermessage = [
      ...
      'error_getting_col_list':["pt":"Erro a obter lista de colecções","en":"Error getting collection list"],           
      'error_getting_rdoc_list':["pt":"Erro a obter lista de documentos anotados","en":"Error getting tagged document list"],           
      'error_getting_sdoc_list':["pt":"Erro a obter lista de documentos fonte","en":"Error getting source document list"],           
      'error_getting_user_list':["pt":"Erro a obter lista de utilizadores","en":"Error getting user list"],           
      'error_getting_ne_list':["pt":"Erro a obter lista de EMs","en":"Error getting NE list"],           
      'error_getting_entity_list':["pt":"Erro a obter lista de entidades","en":"Error getting entity list"],           
      'error_getting_geoscope_list':["pt":"Erro a obter lista de âmbitos geográficos","en":"Error getting geoscope list"],           
      'error_getting_subject_list':["pt":"Erro a obter lista de assuntos","en":"Error getting subject list"],           
      'error_getting_subjectground_list':["pt":"Erro a obter lista de asssuntos referenciados","en":"Error getting sbject ground list"],           
      'error_updating_collection':["pt":"Erro durante a modificação da colecção","en":"Error updating collection"],           
      'error_updating_permission':["pt":"Erro durante a modificação de permissões","en":"Error updating permissions"],           
      ...
      "nenotfound":["pt":"NE não encontrada", "en":"NE not found"],
      ...
      "no_permissions_found":["pt":"Não foram encontrados registos de permissões", "en":"No permission records found"],
      "ok":["pt":"OK", "en":"OK"],
      ...
      "user_cant_read_collection":["pt":"Permissão para ler colecção negada", "en":"Permission to read collection denied"], 
      ...
      "user_not_allowed_to_query_perms":["pt":"Utilizador não autorizado para consultar permissões","en":"User not allowed to query permissions"],
