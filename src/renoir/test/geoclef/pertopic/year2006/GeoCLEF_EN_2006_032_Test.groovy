 ...
 *
 */
 class GeoCLEF_EN_2006_032_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_EN_2006_032_Test() {
    ...
    void testTopic() {
		String lang = "en"
		String topic = "label:032 Independence movement in Quebec"
		...
		assert question.sentence*.text == ['Independence','movement','in','Quebec']
	...
	// check detected NEs 
		...
		assert question.nes.siåze() == 2
		assert question.nes[0].terms*.text == ['Independence']
...
label:032 contents:"Independence" contents:movement contents:"Quebec" ne-ACONTECIMENTO-EFEMERIDE-index:"Independence" woeid-index:2344924
"""
