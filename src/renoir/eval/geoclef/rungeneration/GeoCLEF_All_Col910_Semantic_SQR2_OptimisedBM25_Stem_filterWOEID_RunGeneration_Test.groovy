 ...
 *
 */
class GeoCLEF_All_Col910_Semantic_SQR2_OptimisedBM25_Stem_filterWOEID_RunGeneration_Test extends GroovyTestCase {
    ...
    public GeoCLEF_Baseline_NoQE_RunGeneration_Test create(year, collection_id, lang) {
		...
		"GeoCLEF_${lang.toUpperCase()}_${year}_${type}_${weight}.query",
