 ...
 *
 */
 class GeoCLEF_PT_2006_049_Test extends GroovyTestCase {
        
    Configuration conf 
    GeoCLEF_PerTopic_Test pertopic
    static Logger log = Logger.getLogger("JUnitTest")

    public GeoCLEF_PT_2006_049_Test() {
    ...
    void testTopic() {
		String lang = "pt"
		String topic = "label:049 A ETA em França" 
...
*/
		...
		assert question.sentence*.text == ['A','ETA','em','França']
	...
	// check conditions 
		...
		assert question.conditions[0].object.ne.terms*.text == ['França']
